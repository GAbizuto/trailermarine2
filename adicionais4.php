...
<body>
  ...
  <div class="cima">
    ...
    <div class="selecionado"> Pacote selecionado:      HAVAí </div>
  </div>
  <br><br>
  ...
  <div class="container">
    ...
    <div class="infopacote"><img src="imagens/pacote 4.jfif" width="200px"
    ...
    <fieldset>
      ...
      <div class="confirma">
        CONFIRMAR:
        <button type="submit"  onclick="confirmar();" class="confirmar">
